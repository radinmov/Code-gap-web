    ...
    <PrimaryLayout >
      ...
      <div className="catogry p-14">
        ...
        <div className="catogry_inner flex w-9/12 ">
          <button className="prog w-96 h-36 text-black rounded-md">برنامه نویسی</button>
          <button className="int w-96 h-36 text-black rounded-md">شبکه  </button>
          <button className="int_2 w-96 h-36 text-black rounded-md">شبکه سازی  </button>
          <button className="ai w-96 h-36 text-black rounded-md">هوش مصنوعی</button>
        </div>
      <div className="events_iran ">
          <div className="right">
            <img alt="pepople" src="https://asrdidani.net/wp-content/uploads/2024/06/S-2-2048x1079.png" />
          </div>
          <div className="left">
            <p>یک رویداد بین الملی برای تمامی ایرانیان</p>
            <p>در کد گپ سعی میکنیم به دوستانمان قدرت خود ابرازی بدهیم  که تجربه هایشان را با یکدیگر در میان بگذارند </p>
            <button className="text-black bg-white">حمایت ازکد گپ</button>
          </div>
      </div>
      </div>
    </PrimaryLayout>
